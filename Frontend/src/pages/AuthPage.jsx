  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
        ...
        <div className="absolute top-[-50px] left-[-50px] w-32 h-32 bg-indigo-100 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
        <div className="absolute bottom-[-50px] right-[-50px] w-40 h-40 bg-purple-100 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-gray-500 text-sm">
            {isLogin ? 'Увійдіть, щоб продовжити покупки' : 'Приєднуйтесь до нашої спільноти сьогодні'}
          </p>
        </div>
        ...
        <div className="mt-6 relative z-10">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500">Або продовжити через</span>
            </div>
          </div>

          <div className="mt-6 grid grid-cols-2 gap-3">
            <button type="button" onClick={async () => await showAlert('Вхід через Google в розробці')} className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
              <span className="sr-only">Вхід через Google</span>
            ...
            <button type="button" onClick={async () => await showAlert('Вхід через GitHub в розробці')} className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
              <span className="sr-only">Вхід через GitHub</span>
